...
4b. **TM1+TM2 — ★ The Tense Machine (done):** the standalone live home of the tense system at
   `#/tenses` (spec: `TENSE-MACHINE-SPEC.md`): the 12-cell WALL conjugating a curated verb set for
