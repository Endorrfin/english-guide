// src/i18n/LangProvider.tsx — the EN/UA runtime toggle provider (ported from ../database guide).
// CHANGED (S0.1): bootstrapped at S0 — scripts/smoke.ts renders everything inside this provider.
