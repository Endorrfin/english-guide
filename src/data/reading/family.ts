...
/*
 * Reading · category: family (S3 golden batch). Verbatim transcription + full UA translation.
 * NOTE: this screenshot did not capture a creator credit, so `source` is intentionally omitted —
 * flag for the owner to attribute or replace before public deploy (owner decision S3: verbatim + attribution).
 */
