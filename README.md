...
**D2–D8 — shipped:** seven more Definitions waves (**+365 cards**) — the dictionary is now **535 words
(150 A1 + 385 custom)**. D7 (+68) is the first monthly wave from `_examples/definition_v2.txt` (business/
...
**Next:** content again — dictionary wave W2 (535 → ~1,000 words) and Section III (Core Grammar) with the
